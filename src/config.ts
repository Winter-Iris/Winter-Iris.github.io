...
export const siteConfig: SiteConfig = {
	...
	bangumi: {
		userId: "1201913", // 在此处设置你的Bangumi用户ID，可以设置为 "sai" 测试
	...
	font: {
		...
		cjkFont: {
			...
			fontFamily: "LXGW",
			fontWeight: "500",
			localFonts: ["LXGWBrightCode-Regular.ttf"],
			enableCompress: true, // 启用字体子集优化，减少字体文件大小
		},
	},
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/Winter-Iris",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/3546578830756435",
					external: true,
...
export const pioConfig: import("./types/config").PioConfig = {
	...
	dialog: {
		welcome: "Welcome to Winter-Iris's", // 欢迎词
		touch: [
			"What are you doing?",
			"Stop touching me!",
			"HENTAI!",
...
export const umamiConfig = {
	...
	scripts: `
	<script defer src="https://cloud.umami.is/script.js" data-website-id="e5703559-40fb-458a-88ef-6000c26b3995"></script>
